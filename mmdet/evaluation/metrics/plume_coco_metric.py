...
class PlumeCocoMetric(BaseMetric):
    ...
    """
    default_prefix: Optional[str] = 'plume_coco'
    ...
    def __init__(self,
        ...
        allowed_metrics = ['bbox', 'segm', 'proposal', 'proposal_fast', 'emission_rmse']
    ...
    def results2json(self, results: Sequence[dict],
        ...
        for idx, result in enumerate(results):
            ...
            for i, label in enumerate(labels):
                ...
                data['emission'] = float(emissions[i])
    ...
    def process(self, data_batch: dict, data_samples: Sequence[dict]) -> None:
        ...
        for data_sample in data_samples:
            ...
            result['emissions'] = pred['emissions'].cpu().numpy()
            # encode mask to RLE
            if 'masks' in pred:
            ...
            gt['emissions'] = data_sample['gt_instances']['bboxes_emissions'].cpu().numpy()
